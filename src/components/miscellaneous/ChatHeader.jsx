...
import { Avatar, Modal, Box, TextField, Button, Chip, CircularProgress } from "@mui/material";
      ...
      >
        <Box className="modal-box">
          <Avatar
            ...
            src={
              selectedChat.isGroupChat ? selectedChat.groupPic : otherUser?.pic
            }
          ...
          {selectedChat.isGroupChat && (
            <p>Group Admin: {selectedChat.groupAdmin.name}</p>
          )}
          {isGroupAdmin && selectedChat.isGroupChat && (
            <>
              <TextField
                ...
                fullWidth
              />
              <Button onClick={handleChangeGroupName}>Change Group Name</Button>
              <TextField
  label="Search Users"
  value={userSearch}
                ...
                {selectedChat.users.map((user) => (
                  <div className="user-item" key={user._id}>
                    ...
                    {isGroupAdmin && (user._id!==currentUserId)? (
                      <Button onClick={() => handleRemoveUserFromGroup(user._id)}>
                        <DeleteIcon />
                      </Button>
                    ):null}
                  </div>
